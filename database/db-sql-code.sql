...
CREATE TABLE public.dealership (
  dealership_id INT GENERATED BY DEFAULT AS IDENTITY,
  dealership_name CHARACTER VARYING NOT NULL,
  dealership_address CHARACTER VARYING NOT NULL,
...
-- Add dealership_id to the inventory table
ALTER TABLE public.inventory ADD dealership_id integer;
...
-- Create relationship between 'dealership' and 'inventory' tables
ALTER TABLE IF EXISTS public.inventory
  ADD CONSTRAINT fk_dealership FOREIGN KEY (dealership_id)
  REFERENCES public.dealership (dealership_id) MATCH SIMPLE
  ON UPDATE CASCADE
  ON DELETE NO ACTION;
