...
validate.accountUpdateRules = () => {
  return [
    ...
    body("account_id")
      .trim()
      .isInt({ min: 1 })
      .withMessage("Please specify which account these updates are pertaining to."), // on error this message is sent.
  ]
}
...
/* ******************************
 * Check data and return errors or continue with password update
 * ***************************** */
